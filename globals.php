<?php
if (!defined('PROJECT_ROOT')) define('PROJECT_ROOT', '/var/www/vhosts/qors.io/httpdocs/');
if (!defined('FILE_DEFAULT_DIR')) define('FILE_DEFAULT_DIR', PROJECT_ROOT.'files'.DIRECTORY_SEPARATOR);
if (!defined('S_APP_DIR')) define('S_APP_DIR', PROJECT_ROOT.'service'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR);
...
if (!defined('VIDEO_JSO_DIR')) define('VIDEO_JSO_DIR', S_DATA.'videojson'.DIRECTORY_SEPARATOR);
